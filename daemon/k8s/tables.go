...
func newNameIndex[Obj metav1.Object]() statedb.Index[Obj, types.NamespacedName] {
	return statedb.Index[Obj, types.NamespacedName]{
		Name: "name",
		FromObject: func(obj Obj) index.KeySet {
			return index.NewKeySet(
				index.Stringer(types.NamespacedName{Namespace: obj.GetNamespace(), Name: obj.GetName()}),
			)
		},
