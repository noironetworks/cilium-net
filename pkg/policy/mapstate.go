...
func NewMapStateEntry(e MapStateEntry) mapStateEntry {
	//var ruleSet set.Set[unique.Handle[string]]
	//switch len(derivedFrom) {
	//case 0:
	//case 1:
	//	ruleSet = set.NewSet(unique.Make(derivedFrom[0].String()))
	//default:
	//	for i := range derivedFrom {
	//		ruleSet.Insert(unique.Make(derivedFrom[i].String()))
	//	}
	//}
